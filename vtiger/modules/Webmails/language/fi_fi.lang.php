...
'LBL_SETTINGS'=>'Saapuvan sähköpostipalvelimen asetukset',
...
'LBL_FROM'=>'Keneltä :',
'LBL_CC'=>'CC :',
'LBL_REPLY_TO_SENDER'=>'Vastaa lähettäjälle',
'LBL_REPLY_ALL'=>'Vastaa kaikille',
'LBL_SHOW_HIDDEN'=>'Näytä piilotetut viestit',
'LBL_EXPUNGE_MAILBOX'=>'Poista viestit',
...
'Activtiy Type'=>'Aktiivisuus tyyppi',
'Related To'=>'Liittyy',
'Assigned To'=>'Ohjattu',
'Subject'=>'Aihe',
'Attachment'=>'Liite',
...
'Created Time'=>'Luonti aika',
'Modified Time'=>'Muokkaus aika',
...
'LBL_MAIL_CONNECT_ERROR'=>'Palvelimeen ei saatu yhteyttä. Tarkista palvelimen asetukset',
'IN_REPLY_TO_THE_MESSAGE' => 'Vastaa lähettäjälle ',
...
'LBL_INFO'=>'Info',
'LABEL_DATE'=>'Päiväys',
'LBL_NO_IFRAMES_SUPPORTED'=>'Iframeja ei tueta',
'LBL_EMAIL_ATTACHMENTS'=>'Sähköpostin liiteet:',
'LBL_ALLMAILS'=>'Kaikki viestit',
'LBL_TO_USERS'=>'Käyttäjille',
'LBL_TO_GROUPS'=>'Ryhmille',
'SUBJECT' => 'Aihe',
'BODY' => 'Viesti',
'TO' => 'To:',
'CC' => 'CC:',
...
'FROM' => 'Lähettäjä:',
'IN'=>' ',
'ADD_FOLDER' => 'Lisää kansio[X]',
//Added for 5.0.3
'LBL_LOADING_IMAGE' => 'Ladataan kuvaa',
'LBL_ENABLE_IMAP_SUPPORT' => 'Php asetusten pitää sallia tuki IMAP:lle jotta voit käyttää tätä modulia',

// Added/Updated for vtiger CRM 5.0.4
'LBL_CONFIGURE_MAIL_SETTINGS'=>'Määrittele sähköpostin asetukset',
'LBL_PLEASE'=>'Ole ystävällinen',
'LBL_HERE'=>'Tähän',

// Added after 5.0.4 GA
'LBL_FULL_EMAIL_VIEW'=>'Sähköpostin kokonäkymä', 
'LBL_MESSAGE'=>'Viesti', 
'LBL_MESSAGES'=>'Viestit',

'LBL_NO_ATTACHMENTS'=>'Ei ladattavia tiedostoja', 
